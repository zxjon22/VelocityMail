...
namespace VelocityMail
{
    ...
    static class VelocityEngineFactory
    {
        ...
        internal static VelocityEngine Create(string namespacePrefix, string assemblyName)
        {
        ...
        /// <returns>New VelocityEngine instance</returns>
        internal static VelocityEngine CreateUsingDirectory(string path)
        {
            var props = new ExtendedProperties();
        ...
        /// <returns>New VelocityEngine instance</returns>
        internal static VelocityEngine Create(string namespacePrefix, string assemblyName, string path)
        {
